    ...
    <div className="min-h-screen bg-white text-[#1d1d1f] antialiased">
      ...
      <header className="sticky top-0 z-20 border-b border-black/5 bg-white/80 backdrop-blur-xl">
        <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-6">
          ...
          <nav className="flex items-center gap-6">
            <Link href="/login" className="text-sm text-[#1d1d1f]/80 transition hover:text-[#1d1d1f]">
              Entrar
            </Link>
            <Link
              href="/register"
      ...
      <section className="mx-auto max-w-4xl px-6 pb-24 pt-24 text-center sm:pt-32">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          <Link
            href="/login"
            className="rounded-full px-7 py-3 text-[15px] font-medium text-[#0071e3] transition hover:underline"
          >
            Já tenho conta ›
          </Link>
        </div>
      ...
      <section className="bg-[#f5f5f7] py-24">
        <div className="mx-auto grid max-w-5xl gap-6 px-6 md:grid-cols-2">
          <div className="rounded-3xl bg-white p-10 shadow-[0_2px_16px_rgba(0,0,0,0.04)]">
            <p className="text-sm font-medium text-[#6e6e73]">Para marcas</p>
            ...
            <Link href="/register" className="mt-6 inline-block text-[15px] font-medium text-[#0071e3] hover:underline">
              Criar conta de marca ›
            </Link>
          </div>

          <div className="rounded-3xl bg-white p-10 shadow-[0_2px_16px_rgba(0,0,0,0.04)]">
            <p className="text-sm font-medium text-[#6e6e73]">Para influenciadores</p>
            <h2 className="mt-2 text-3xl font-semibold tracking-tight">
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {FEATURES.map((feature) => (
              <div key={feature.title} className="rounded-3xl bg-white p-8 shadow-[0_2px_16px_rgba(0,0,0,0.04)]">
                ...
                <p className="mt-2 text-sm leading-relaxed text-[#6e6e73]">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="mx-auto max-w-3xl px-6 py-28 text-center">
        ...
        <Link
          href="/register"
          className="mt-8 inline-block rounded-full bg-[#0071e3] px-8 py-3.5 text-[15px] font-medium text-white transition hover:bg-[#0077ed]"
        >
          Criar conta grátis
        </Link>
      </section>

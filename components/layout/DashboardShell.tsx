...
const NAV: Record<AccountType, { href: string; label: string; icon: IconName }[]> = {
  influencer: [
    ...
    { href: "/influencer/oportunidades", label: "Oportunidades", icon: "links" },
  ...
  brand: [
    ...
    { href: "/brand/discover", label: "Descobrir influenciadores", icon: "users" },
    { href: "/brand/ambassadors", label: "Meus influenciadores", icon: "ambassadors" },
